...
export function Logo({ width = 82, height = 69.7, className }: LogoProps) {
  return (
    <svg
      version="1.1"
      id="Layer_1"
      ...
      y="0px"
      viewBox="0 0 82 69.7"
      enableBackground="new 0 0 82 69.7"
      xmlSpace="preserve"
      width={width}
      height={height}
      className={className}
      role="img"
      aria-label="Dev4Room logo"
    >
      <style type="text/css">
        {`
      ...
      <g>
        <g>
          <linearGradient
            ...
            x2="2.7039"
            y2="88.6413"
            gradientTransform="matrix(1 0 0 -1 0 71)"
          >
            <stop offset="0" style={{ stopColor: "#2e8fff" }} />
            <stop offset="1" style={{ stopColor: "#3c5bba" }} />
          </linearGradient>
          <path
            className="st0"
            d="M37.4,27.3H23.3c-1.6,0-2.9,1.3-2.9,2.9v14.1c0,1.6,1.3,2.9,2.9,2.9h14.1c1.6,0,2.9-1.3,2.9-2.9V30.2
			C40.3,28.6,39,27.3,37.4,27.3z"
          />

          <linearGradient
            id="SVGID_00000103224651137331730470000007581136528744358801_"
            gradientUnits="userSpaceOnUse"
            x1="43.2584"
            y1="25.8414"
            x2="9.7999"
          ...
          <path
            style={{
              fill: "url(#SVGID_00000103224651137331730470000007581136528744358801_)",
            }}
            d="M50.9,50.6h-5.8c-0.6,0-1.2,0.5-1.2,1.2
			v5.7c0,0.6,0.5,1.2,1.2,1.2h5.8c0.6,0,1.2-0.5,1.2-1.2v-5.8C52.1,51.1,51.6,50.6,50.9,50.6z"
          />

          <linearGradient
            id="SVGID_00000088128258541193902010000015920812359292338604_"
            gradientUnits="userSpaceOnUse"
            x1="61.7359"
            y1="35.155"
            x2="28.2775"
          ...
          <path
            style={{
              fill: "url(#SVGID_00000088128258541193902010000015920812359292338604_)",
            }}
            d="M58,0H41.2c-1.9,0-3.4,1.5-3.4,3.4v16.9
        ...
        <g>
          <g>
            <linearGradient
              id="SVGID_00000113352272450243288590000011317773283457320333_"
              gradientUnits="userSpaceOnUse"
              x1="5.8227"
              y1="29.7851"
              x2="5.8227"
              ...
              gradientTransform="matrix(1 0 0 -1 0 71)"
            >
              <stop offset="0" style={{ stopColor: "#7eb7f7" }} />
              <stop offset="1" style={{ stopColor: "#2e8fff" }} />
            </linearGradient>
            <path
              style={{
                fill: "url(#SVGID_00000113352272450243288590000011317773283457320333_)",
              }}
              d="M9.6,13c0-0.8,0.5-1.5,1.1-1.9
            ...
            <linearGradient
              id="SVGID_00000098925987832892611870000017160774970843739810_"
              gradientUnits="userSpaceOnUse"
              x1="5.8227"
              y1="13.9414"
              x2="5.8227"
              ...
              gradientTransform="matrix(1 0 0 -1 0 71)"
            >
              <stop offset="0" style={{ stopColor: "#5fabf7" }} />
              <stop offset="1" style={{ stopColor: "#2063ba" }} />
            </linearGradient>
            <path
              style={{
                fill: "url(#SVGID_00000098925987832892611870000017160774970843739810_)",
              }}
              d="M10.8,62.6c-0.7-0.3-1.1-1.1-1.1-1.9
          ...
          <g>
            <linearGradient
              id="SVGID_00000039125631799071176600000008147344663216026761_"
              gradientUnits="userSpaceOnUse"
              x1="-68.3112"
              y1="29.7851"
              x2="-68.3112"
              y2="60.6867"
              gradientTransform="matrix(-1 0 0 -1 7.7115 71)"
            >
              <stop offset="0" style={{ stopColor: "#7eb7f7" }} />
              <stop offset="1" style={{ stopColor: "#2e8fff" }} />
            </linearGradient>
            <path
              style={{
                fill: "url(#SVGID_00000039125631799071176600000008147344663216026761_)",
              }}
              d="M72.2,13c0-0.8-0.5-1.5-1.1-1.9
            ...
            <linearGradient
              id="SVGID_00000086653289684303678680000012253593631453312176_"
              gradientUnits="userSpaceOnUse"
              x1="-68.4035"
              y1="13.9414"
              x2="-68.4035"
            ...
            <path
              style={{
                fill: "url(#SVGID_00000086653289684303678680000012253593631453312176_)",
              }}
              d="M71.1,62.6c0.7-0.3,1.1-1.1,1.1-1.9
