...
const RightSidebar = () => {
  return (
    <section className="no-scrollbar bg-light900_dark200 light-border right-0 top-0 h-screen w-75 flex flex-col justify-start border-l p-6 pt-32 shadow-light-300 dark:shadow-none overflow-y-auto max-xl:hidden">
      <div>
