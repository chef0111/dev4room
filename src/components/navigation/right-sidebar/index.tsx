...
const RightSidebar = () => {
  return (
    <section className="no-scrollbar bg-sidebar light-border shadow-light-300 fixed top-0 right-0 flex h-screen w-75 flex-col justify-start overflow-y-auto border-l p-5 pt-32 max-xl:hidden dark:shadow-none">
      <div>
